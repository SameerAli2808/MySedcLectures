...
namespace JsonWriterReader
{
    class Program {
        ...
        static void Main(string[] args) { 
            ...
            string path = @"E:\My Files\SEDC\mySedcLectures\06- OOP with C# - Advanced\csa_session12_2019-04-24\videogames.json";

            // Write JSON directly to a file
            File.WriteAllText(path, videogameRatings.ToString()); 

            //write JSON with JsonTextWriter
            path = @"E:\My Files\SEDC\mySedcLectures\06- OOP with C# - Advanced\csa_session12_2019-04-24\videogames2.json";
            ...
            path = @"E:\My Files\SEDC\mySedcLectures\06- OOP with C# - Advanced\csa_session12_2019-04-24\JsonPersonsWritten.json";
