...
namespace BinarySerialization
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = @"E:\My Files\SEDC\mySedcLectures\06- OOP with C# - Advanced\csa_session12_2019-04-24\Employee.bin";
            ...
            string pathForList = @"E:\My Files\SEDC\mySedcLectures\06- OOP with C# - Advanced\csa_session12_2019-04-24\EmployeeList.bin";
